...
\begin{figure}[th]
	\centering
	\includegraphics[width=0.7\linewidth]{../../gitRaspi/Abschlussbericht/aufbauMitCam}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=0.7\linewidth]{../../gitRaspi/Abschlussbericht/storm32}
	\caption{STorM32BGC}
	\label{fig:storm32}
\end{figure}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=0.7\linewidth]{../../gitRaspi/Abschlussbericht/ESC}
...
\begin{figure}[ht]
	\centering
	\subfigure[Bestückungsseite]{\includegraphics[width=0.49\textwidth]{platinePlanVorn}} 
	\subfigure[Lötseite]{\includegraphics[width=0.49\textwidth]{platinePlanHinten}} 
	\caption{Bestückungs- und Lötplan für die Schaltung} 
	\label{fig:platinePlan}
\end{figure} 
